...
Class is in session! Here you will find resources to learn about the tools and techniques used for Open-Source Intelligence. You might also check out [the wiki](https://github.com/OSINTI4L/The-Kitchen-Sink/wiki) where you can find detailed walk-throughs and guides of various OSINT techniques.
