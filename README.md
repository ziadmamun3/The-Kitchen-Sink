...
If you would like to remove yourself from certain OSINT/data broker databases, I have added a small list of [Data Broker Removal Guides](https://github.com/OSINTI4L/The-Kitchen-Sink/blob/main/DataBrokerRemoval.md) to teach you how to do just that.
